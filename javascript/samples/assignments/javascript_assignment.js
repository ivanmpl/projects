...
var x = 32243
var str = reverseNumber(x)
console.log(str)
console.log(reverseNumber(12422))
...
function palindromeCheck(str) {
    ...
    var strBackward = str.toString().split('').reverse().join('');
    for (var i = 0; i < str.length; i++) {
        if (str[i] != strBackward[i]) {
            isPalindrome = false;
        }
    }
...
console.log(palindromeCheck('test'))
...
function generateAllCombos(str) {
    ...
    for (var i = 0; i < strArray.length; i++) {
        ...
        var strChar = strArray[i]
        result.push(strChar)

        for (var j = 0; j < strArray.length; j++) {

            if (i != j) {
                result.push(strChar + strArray[j])
            }
        }
    }
...
console.log(generateAllCombos("dog"))
console.log(generateAllCombos("raw"))
...
console.log(firstLetterToUpper("test this line"))
...
console.log(findLongestWord("big small bigger little largest "))
...
console.log(checkPrimality(11));
console.log(checkPrimality(44));
...
function findSecondLowestGreatest(arr) {
    ...
    for (let index = 0; index < arr.length; index++) {
        ...
        if (lowest2 > arr[index] && arr[index] != lowest) {

            lowest2 = arr[index];
        }

        if (greatest2 < arr[index] && arr[index] != greatest) {
            greatest2 = arr[index];
        }
    }
    ...
    console.log("2nd Lowest: " + lowest2)
    console.log("2nd Greatest: " + greatest2)
}

var arr = [, 2, 3, 4, 5]
findSecondLowestGreatest(arr);
arr = [42, 2, 31, 55, 88]
findSecondLowestGreatest(arr);
